    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-start">
        <div>
          ...
          <p className="text-gray-600 mt-1">Organiza tus transacciones en categorías</p>
        </div>
        ...
        <Card>
          <CardContent className="p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-sm text-gray-600">Categorías de Ingreso</p>
                <p className="text-3xl font-bold text-gray-900">{incomeCategories.length}</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-sm text-gray-600">Categorías de Egreso</p>
                <p className="text-3xl font-bold text-gray-900">{expenseCategories.length}</p>
              </div>
            </div>
          </CardContent>
        </Card>
